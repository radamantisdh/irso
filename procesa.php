...
//Esta linea es para incluir el archivo con las variables
    ...
    $database = mysql_select_db("irso",$con);
...
//REALIZAR CONSULTA
	$sql = "INSERT INTO tramite VALUES  (NULL,'".$_POST['nro_asd']."','"
            ...
            ,'".$_POST['soli_rut']."','".$_POST['soli_dv']."','".$_POST['rep_leg_nombre']."','".$_POST['rep_leg_ap_pat']."',
            '".$_POST['rep_leg_ap_mat']."','".$_POST['rep_leg_rut']."','".$_POST['rep_leg_dv']."'
