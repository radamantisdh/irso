    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">L-7.1</a></li>
                <li><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-7-1">Solicitud inscripción y registro de expertos en prevención de riesgos profesionales. (Extravío Credencial Experto)</a></li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-7-1" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="views/actions/save_L-7-1.php" class="form-horizontal" id="save_l7_1" method="post">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label"><b>Numero ASDigital:</b></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese N°" name="nro_asd" requiered>
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label"><b>Nº Resolución de Experto:</b></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese N° resolución" name="soli_num_res_expert" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label"><b>Nº Registro: </b></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese N° Registro" name="soli_num_reg" required>
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                ...
                                <div class="panel-body">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label"> Fotocopia Resolución de experto:</label>
                                        <div class="col-sm-7">
