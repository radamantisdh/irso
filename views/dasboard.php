  ...
  <li><a href="changelogs.html"><span class="icon color12"><i class="fa fa-file-text-o"></i></span>Changelogs</a></li>-->
    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                <li class="active">Sistema de ingreso de resoluciones de salud ocupacional</li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=dasboard" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                    ...
                    <div class="panel panel-widget">
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-dic table-hover ">
                                <tbody>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-6">L-6 Solicitud para ingreso o certificación reglamento interno.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-7">L-7 Solicitud inscripción y registro de expertos en prevención de riesgos profesionales.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-7-1">L-7.1 Solicitud inscripción y registro de expertos en prevención de riesgos profesionales. (Extravío Credencial Experto).</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-9">L-9 Solicitud enrolamiento sanitario.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-10">L-10 Solicitud Curso de Calderas y Rayos.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-18">L-18 Solicitud autorización sanitaria empresas aplicadoras de pesticidas de uso santitario y doméstico – Decreto Supremo N° 157/2005, MINSAL</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-1">1 SOLICITUD DE AUTORIZACIÓN DE DESEMPEÑO EN INSTALACIONES RADIACTIVAS DE 2ª y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-2">2 SOLICITUD DE AUTORIZACIÓN DE OPERACIÓN DE INSTALACIONES RADIACTIVAS Y EQUIPOS DE 2ª y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-3">3 SOLICITUD DE AUTORIZACIÓN DE DICTACIÓN DE CURSO DE PROTECCIÓN RADIOLÓGICA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-4">4 SOLICITUD DE AUTORIZACIÓN DE TRANSPORTE DE SUSTANCIA RADIACTIVA DE 2ª Y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-5">5 SOLICITUD DE AUTORIZACIÓN DE DESECHOS DE SUSTANCIAS RADIACTIVAS</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-6">6 SOLICITUD DE CIERRE TEMPORAL O DEFINITIVO DE INSTALACIÓN RADIACTIVA DE 2ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-7">7 SOLICITUD DE AUTORIZACIÓN DE IMPORTACIÓN DE SUSTANCIAS RADIACTIVAS Y/O EQUIPOS CON FUENTES RADIACTIVAS</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-folder-open-o"></i><a href="<?php  echo $GLOBALS['base']; ?>?modulo=SOLI-8">8 SOLICITUD DE AUTORIZACIÓN DE EXPORTACIÓN DE SUSTANCIAS RADIACTIVAS</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
