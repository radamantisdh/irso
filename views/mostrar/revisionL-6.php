    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">L-6</a></li>
                <li><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-6">Solicitud para ingreso o certificación reglamento interno.</a></li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-6" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                </div>
            </div>
                            ...
                            <form action="save.html" class="form-horizontal">
                                <div class="panel-body">
                                    ...
                                    <div class="panel-title">
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <p class="form-control-static">2 .-Representante Legal: </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="panel-title">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <p class="form-control-static">3 .-Organismo Administrador Ley 16.744: </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-2 radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio11" value="option1" name="organismo_16744" required>
                                            <label for="inlineRadio11"> A.CH.S. </label>
                                        </div>
                                        <div class="col-sm-2 radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio12" value="option1" name="organismo_16744" required>
                                            <label for="inlineRadio12"> C.CH.C.</label>
                                        </div>
                                        <div class="col-sm-2 radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio13" value="option1" name="organismo_16744" required>
                                            <label for="inlineRadio13">I.S.T. </label>
                                        </div>
                                        <div class="col-sm-2 radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio14" value="option1" name="organismo_16744" required>
