                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="save.html" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label form-label">N°:</label>
                                    <div class="col-sm-1">
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Nombre de Curso:</label>
                                    <div class="col-sm-3">
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Fecha de Inicio/Termino/Horarios:</label>
                                    <div class="col-sm-2">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-2 control-label form-label">Rut:</label>
                                    <div class="col-sm-2">
                                    </div>
                                    <div class="col-sm-1">
                                    </div>
...
================================================ -->
    ...
    $(document).ready(function() {
        ...
        $('#date-range-and-time-picker1').daterangepicker({
            timePicker: true,
            timePickerIncrement: 30,
            format: 'DD/MM/YYYY h:mm A'
        }, function(start, end, label) {
        ...
        $('#date-range-and-time-picker2').daterangepicker({
            timePicker: true,
            timePickerIncrement: 30,
            format: 'DD/MM/YYYY h:mm A'
        }, function(start, end, label) {
