                            ...
                            <form action="save.html" class="form-horizontal">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio11" value="option1" name="curso_nivel" required>
                                        <label for="inlineRadio11"> Alta </label>
                                    </div>
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio12" value="option1" name="curso_nivel" required>
                                        <label for="inlineRadio12"> Mediana </label>
                                    </div>
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio13" value="option1" name="curso_nivel" required>
