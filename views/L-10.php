    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">L-10</a></li>
                <li><a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-10">Solicitud Curso de Calderas y Rayos.</a></li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=L-10" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="views/actions/save_L-10.php" class="form-horizontal" id="save_l10" method="post">
                                <div class="form-group">
                                ...
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">1 .- Nombre o razón social solicitante: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">2 .- Dirección establecimiento: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">4 .- CURSO A REALIZAR: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label"><b>Calderas:</b></label>
                                    <div class="col-sm-8 ">
                                        <select class="selectpicker" name="curso_nombre">
                                            <option value="">Seleccione curso</option>
                                            <option value="Calefacción y Agua caliente">Calefacción y Agua caliente</option>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio11" value="Alta" name="curso_nivel" required>
                                        <label for="inlineRadio11"> Alta </label>
                                    </div>
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio12" value="Mediana" name="curso_nivel" required>
                                        <label for="inlineRadio12"> Mediana </label>
                                    </div>
                                    <div class="col-sm-3 radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio13" value="Baja" name="curso_nivel" required>
                                        <label for="inlineRadio13"> Baja </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label"> Programa del Curso:</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label"> Manual del curso del operador: </label>
                                        <div class="col-sm-7">
                                            <p class="form-control-static">
                                                <input type="file" style="border: 0px !important;" >
                                            </p>
                                    ...
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label">Antecedentes del o los Relatores (Curriculum):</label>
                                        <div class="col-sm-7">
                                            <p class="form-control-static">
                                                <input type="file" style="border: 0px !important;" >
                                            </p>
                                    ...
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label">Fecha de inicio y término del curso: </label>
                                        <div class="col-sm-7">
                                            <p class="form-control-static">
                                                <input type="file" style="border: 0px !important;" >
                                            </p>
                                    ...
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="col-sm-5 control-label form-label">Lugar de realización del curso: </label>
                                        <div class="col-sm-7">
                                            <p class="form-control-static">
                                                <input type="file" style="border: 0px !important;" >
                                            </p>
