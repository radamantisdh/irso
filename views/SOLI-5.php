                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="views/actions/save_soli-5.php" class="form-horizontal" id="save_soli5" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Ciudad:</label>
                                    <div class="col-sm-4 ">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Ciudad" name="instalacion_destino_ciudad" required>
                                    </div>
