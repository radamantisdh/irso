    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">3</a></li>
                <li><a href="<?php  echo $GLOBALS['base']; ?>?modulo=soli-3">Solicitud de autorización de dictación de curso de protección radiológica.</a></li>
            </ol>
            <li>Para personal que se desempeñará en instalaciones radiactivas de 2ª y 3ª categoría</li>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=soli-3" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="views/actions/save_soli-3.php" class="form-horizontal" id="save_soli3" method="post">
                                ...
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">1 .- Institución o Empresa: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="tel" maxlength="9" class="form-control" id="input11" placeholder="ej:56912345678" name="soli_telefono">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="panel-title">
                                    3 .- LUGAR DONDE SE DICTARÁ EL CURSO
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Lugar:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Nombre o Lugar de establecimiento donde se dictará el curso" name="estab_nombre" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Dirección:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label form-label">Comuna:</label>
                                    <div class="col-sm-2 ">
                                        <select class="selectpicker" name="estab_comuna" id="estab_comuna">
                                            <option value="">Seleccione comuna</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Teléfono celular:</label>
                                    <div class="col-sm-8">
                                        <input type="tel" maxlength="9" class="form-control" id="input11" placeholder="ej:56912345678" name="estab_celular">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">correo electronico:</label>
                                ...
                                <div class="panel-title">
                                    4 .- Nº DE CURSOS Y FECHAS DE DICTACIÓN (cada curso cancela arancel)
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-1">
                                        <input type="text" class="form-control" id="input11" placeholder="N°" name="curso_numero" required>
                                    </div>
                                    
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Nombre del Curso" name="curso_nombre" required>
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Fecha de Inicio/Termino:</label>
                                    <div class="col-sm-3">
                                        <fieldset>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="input-prepend input-group">
                                                            ...
                                                            <input type="text" id="date-range-picker" class="form-control" value="<?php echo date("d-m-Y"); ?> - <?php echo date("d-m-Y"); ?>" name="curso_fecha" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                        </fieldset>
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Horarios" name="curso_horario" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-1">
                                        <input type="text" class="form-control" id="input11" placeholder="N°" name="curso_numero1">
                                    </div>
                                    
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Nombre del Curso" name="curso_nombre1">
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Fecha de Inicio/Termino:</label>
                                    <div class="col-sm-3">
                                        <fieldset>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="input-prepend input-group">
                                                            <span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <input type="text" id="date-range-picker1" class="form-control" value="<?php echo date("d-m-Y"); ?> - <?php echo date("d-m-Y"); ?>" name="curso_fecha1" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                        </fieldset>
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Horarios" name="curso_horario1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-1">
                                        <input type="text" class="form-control" id="input11" placeholder="N°" name="curso_numero2">
                                    </div>
                                    
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Nombre del Curso" name="curso_nombre2">
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Fecha de Inicio/Termino:</label>
                                    <div class="col-sm-3">
                                        <fieldset>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="input-prepend input-group">
                                                            <span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <input type="text" id="date-range-picker2" class="form-control" value="<?php echo date("d-m-Y"); ?> - <?php echo date("d-m-Y"); ?>" name="curso_fecha2" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                        </fieldset>
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese Horarios" name="curso_horario2">
                                    </div>
                                </div>
                                <div class="panel-title">
                                    5 .- RELATORES
                                ...
                                <div class="form-group">
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="input11" placeholder="Nombre" name="relatores_nombre" required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="8" class="form-control" id="input11" placeholder="Rut" name="relatores_rut" required>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" maxlength="1" class="form-control" id="input11" placeholder="DV" name="relatores_dv" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="input11" placeholder="Nombre" name="relatores_nombre1">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="8" class="form-control" id="input11" placeholder="Rut" name="relatores_rut1">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" maxlength="1" class="form-control" id="input11" placeholder="DV" name="relatores_dv1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="input11" placeholder="Nombre" name="relatores_nombre2">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="8" class="form-control" id="input11" placeholder="Rut" name="relatores_rut2">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" maxlength="1" class="form-control" id="input11" placeholder="DV" name="relatores_dv2">
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="col-sm-12">
...
================================================ -->
    ...
    $(document).ready(function() {
        ...
        $('#estab_region').on('change', function() {
            ...
            $('#estab_comuna').load("views/modales/comunas.php?region=" + region);
            console.log("Comuna Cargada: " + region);
            $("#estab_comuna").find('option').first().attr('selected','selected');
        });
    ...
    $(document).ready(function() {
        ...
        $('#date-range-picker1').daterangepicker(null, function(start, end, label) {
            console.log(start.toISOString(), end.toISOString(), label);
        });
        $('#date-range-picker2').daterangepicker(null, function(start, end, label) {
            console.log(start.toISOString(), end.toISOString(), label);
        });
    });
    </script>
