...
elseif(empty($fecha_ingreso)) { echo $error."El campo <b>Fecha de Ingreso</b> no puede quedar vacio".$finerror; $cago = true; }
    ...
    VALUES ('$nro_asd', '$soli_nombre', '$soli_ap_pat', '$soli_ap_mat', '$soli_rut', 
            ...
            '$rep_leg_celular', '$rep_leg_email', '$estab_nombre', '$estab_calle', '$estab_numero', 
            '$estab_resto', '$estab_region', '$estab_ciudad', '$estab_comuna', '$estab_telefono', 
            '$estab_celular', '$estab_email', '$curso_numero', '$curso_nombre', '$pieces[0]', '$pieces[1]',
            '$curso_horario', '$curso_numero1', '$curso_nombre1', '$pieces1[0]', '$pieces1[1]',
            '$curso_horario1', '$curso_numero2', '$curso_nombre2', '$pieces2[0]', '$pieces2[1]',
            '$curso_horario2', '$relatores_nombre', '$relatores_rut', '$relatores_dv', 
            '$relatores_nombre1', '$relatores_rut1', '$relatores_dv1', '$relatores_nombre2', '$relatores_rut2', 
            '$relatores_dv2', '$fecha_ingreso')";
	pg_query("$sql");
	echo "Insertó la wea";
