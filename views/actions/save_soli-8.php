...
elseif(empty($fecha_ingreso)) { echo $error."El campo <b>Fecha de Ingreso</b> no puede quedar vacio".$finerror; $cago = true; }
	...
	//inserta la mierda
		$sql = "INSERT INTO 	soli_8(
            ...
            instalacion_destino_pais, sustancia_radioiso, sustancia_num_serie, 
            sustancia_bq, sustancia_calibracion, sustancia_bq_actual, sustancia_bq_fecha, 
            fecha_ingreso)
