...
elseif(empty($fecha_ingreso)) { echo $error."El campo <b>Fecha de Ingreso</b> no puede quedar vacio".$finerror; $cago = true; }
	...
	if($cago == false) {
            ...
            $frase1 = str_replace($numeros, $regiones, $rep_leg_region);
            $frase2 = str_replace("_", " ", $rep_leg_ciudad);
            
            $frase3 = str_replace($numeros, $regiones, $estab_region);
            $frase4 = str_replace("_", " ", $estab_ciudad);
    ...
    VALUES ('$nro_asd', '$actividad_rubro', '$soli_nombre', '$soli_ap_pat', 
            '$soli_ap_mat', '$soli_rut', '$soli_dv', '$rep_leg_nombre', '$rep_leg_ap_pat', 
            '$rep_leg_ap_mat', '$rep_leg_rut', '$rep_leg_dv', '$rep_leg_calle', '$rep_leg_numero', 
            '$rep_leg_resto', '$frase1', '$frase2', '$rep_leg_telefono', 
            '$rep_leg_email', '$estab_calle', '$estab_numero', '$estab_resto', '$frase3', 
            '$frase4', '$estab_telefono', '$estab_email', '$estab_num_trab_h', 
            '$estab_num_trab_m', '$organismo_16744', '$fecha_ingreso')";
	pg_query("$sql");
