  ...
  <li><a href="changelogs.html"><span class="icon color12"><i class="fa fa-file-text-o"></i></span>Changelogs</a></li>-->
    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                <li class="active">Sistema de simulación de ingresos de solicitudes de salud ocupacional</li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=simulacion" class="btn btn-light"><i class="fa fa-refresh"></i></a>
  ...
  <!-- End Top Stats -->
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-dic table-hover ">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-6-Solicitud-Reglamento-Interno-Agosto-2010">L-6 Solicitud para ingreso o certificación reglamento interno.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-7-Solicitud-registro-de-Expertos-en-Prevencion">L-7 Solicitud inscripción y registro de expertos en prevención de riesgos profesionales.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-7.1-Solicitud-registro-de-Expertos-en-Prevencion_Extravio">L-7.1 Solicitud inscripción y registro de expertos en prevención de riesgos profesionales. (Extravío Credencial Experto).</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-9-Solicitud-Enrolamiento">L-9 Solicitud enrolamiento sanitario.</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-10-Solicitud-Cursos-Calderas-y-Rayos">L-10 Solicitud Curso de Calderas y Rayos.</a></td>
                                    </tr>
                                
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/L-18-Solicitud-Autorizacion-empresas-Aplicadoras-de-Pesticidas-Domestico">L-18 Solicitud autorización sanitaria empresas aplicadoras de pesticidas de uso santitario y doméstico – Decreto Supremo N° 157/2005, MINSAL</a></td>
                                    </tr>
                                    
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/1-SOLICITUD-AUTORIZACION-DE-DESEMPENO">1 SOLICITUD DE AUTORIZACIÓN DE DESEMPEÑO EN INSTALACIONES RADIACTIVAS DE 2ª y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/2-SOLICITUD-AUTORIZACION-DE-OPERACION-DE-INST.-RAD.-Y-EQUIPOS">2 SOLICITUD DE AUTORIZACIÓN DE OPERACIÓN DE INSTALACIONES RADIACTIVAS Y EQUIPOS DE 2ª y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/3-SOLICITUD-AUTORIZACION-DE-CURSO-DE-PROTECCION-RADIOLOGICA">3 SOLICITUD DE AUTORIZACIÓN DE DICTACIÓN DE CURSO DE PROTECCIÓN RADIOLÓGICA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/4-SOLICITUD-AUTORIZACION-DE-TRANSPORTE">4 SOLICITUD DE AUTORIZACIÓN DE TRANSPORTE DE SUSTANCIA RADIACTIVA DE 2ª Y 3ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/5-SOLICITUD-AUTORIZACION-DE-DESECHOS-SUSTANCIAS-RADIACTIVAS">5 SOLICITUD DE AUTORIZACIÓN DE DESECHOS DE SUSTANCIAS RADIACTIVAS</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/6-SOLICITUD-CIERRE-TEMPORAL-O-DEFINITIVO">6 SOLICITUD DE CIERRE TEMPORAL O DEFINITIVO DE INSTALACIÓN RADIACTIVA DE 2ª CATEGORÍA</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/7-SOLICITUD-AUTORIZACION-DE-IMPORTACION">7 SOLICITUD DE AUTORIZACIÓN DE IMPORTACIÓN DE SUSTANCIAS RADIACTIVAS Y/O EQUIPOS CON FUENTES RADIACTIVAS</a></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i><a href="<?php echo $GLOBALS['base']; ?>doc/8-SOLICITUD-AUTORIZACION-DE-EXPORTACION">8 SOLICITUD DE AUTORIZACIÓN DE EXPORTACIÓN DE SUSTANCIAS RADIACTIVAS</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <!-- End Server Status -->
      ...
      <div class="widget profile-widget" style="height:380px;">
        <img src="views/img/profileimg.png" class="profile-image" alt="img">
        <h1>Jonathan Doe</h1>
        ...
        <ul class="mailbox-inbox">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="views/img/profileimg.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="views/img/profileimg2.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="views/img/profileimg3.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="views/img/profileimg4.png" alt="img" class="img">
      ...
      <div class="panel panel-widget blog-post">
        <div class="panel-body">
          ...
          <div class="image-div color10-bg">
            <img src="views/img/example1.jpg" class="image" alt="img">
          ...
          <a href="#">Read More</a>
          <p class="author">
            <img src="views/img/profileimg.png" alt="img">
      ...
      <div class="panel panel-info panel-widget">
        ...
        <div class="panel-body">
          <ul class="basic-list image-list">
            <li><img src="views/img/profileimg.png" alt="img" class="img"><b>Jonathan Doe</b><span class="desc">Designer</span></li>
            <li><img src="views/img/profileimg2.png" alt="img" class="img"><b>Egemem Ka</b><span class="desc">Front-End Developer</span></li>
            <li><img src="views/img/profileimg3.png" alt="img" class="img"><b>Timmy Jefsin</b><span class="desc">Back-End Developer</span></li>
            <li><img src="views/img/profileimg4.png" alt="img" class="img"><b>James K. Throwing</b><span class="desc">Marketing</span></li>
            <li><img src="views/img/profileimg5.png" alt="img" class="img"><b>John Doe</b><span class="desc">iOS Developer</span></li>
          </ul>
        </div>
      </div>
    </div>
