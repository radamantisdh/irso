    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">1</a></li>
                <li><a href="<?php  echo $GLOBALS['base']; ?>?modulo=soli-1">Solicitud de autorización de desempeño en instalaciones radioactivas de 2ª y 3ª categoría.</a></li>
            </ol>
            <!-- Start Page Header Right Div -->
            <div class="right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="<?php echo $GLOBALS['base']; ?>/salir.php" class="btn btn-light">Salir</a>
                    <a href="<?php  echo $GLOBALS['base']; ?>?modulo=soli-1" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="views/actions/save_soli-1.php" class="form-horizontal" id="save_soli1" method="post">
                                <div class="form-group">
                                ...
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="inlineRadio1" value="Primera Vez" name="solicitud_tipo" class="solicitud" required>
                                    <label for="inlineRadio1"> Primera vez </label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="inlineRadio2" value="Renovacion" name="solicitud_tipo" class="solicitud" required>
                                    <label for="inlineRadio2"> Renovación </label>
                                </div>
                                ...
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">1 .- Datos del solicitante: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Nombre y apellidos:</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="panel-title">
                                    2 .- CAPACITACIONES EN PROTECCIÓN RADIOLÓGICA
                                </div>
                                <div class="panel-body">
                                    <class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label form-label">Nombre del curso:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="input11" placeholder="Ingrese nombre del curso" name="capacitacion_nombre" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label form-label">Nº Resolución:</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="input11" placeholder="Ingrese N°" name="capacitacion_num_res" required>
                                            </div>
                                                    ...
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <div class="input-prepend input-group">
                                                                ...
                                                                <input type="text" id="date-picker" class="form-control" value="<?php echo date("d-m-Y"); ?>" name="capacitacion_fecha"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">SEREMI de Salud que la otorga:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese SEREMI que otorga" name="capacitacion_seremi_ot" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label form-label">Duración (horas):</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese horas" name="capacitacion_duracion" required>
                                    </div>
                                    <label class="col-sm-2 control-label form-label">Institución que impartió el curso:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="input11" placeholder="Ingrese institución" name="capacitacion_institucion" required>
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <p class="form-control-static">3.-Fecha de ingreso: </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body" style="margin-top:12px;">
                                ...
                                <div class="panel-body">
                                    <section id="primera_vez">
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                                <p class="form-control-static"><b>4.1 .- PARA OBTENCIÓN POR PRIMERA VEZ:</b></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Licencia de enseñanza media o su equivalente:</label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Certificado de aprobación de Curso de Protección Radiológica con número de Resolución: </label>
                                            <div class="col-sm-7">
                                                <p class="form-control-static">
                                                    <input type="file" style="border: 0px !important;" >
                                                </p>
                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Certificado de competencia en que conste su idoneidad para el cargo que desempeña, con una experiencia mínima de tres años en el uso de equipos generadores de radiación ionizante y/o manipulación de sustancias radiactivas: </label>
                                            <div class="col-sm-7">
                                                <p class="form-control-static">
                                                    <input type="file" style="border: 0px !important;" >
                                                </p>
                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Certificado de Historial Dosimétrico, emitido por el Instituto de Salud Pública: </label>
                                            <div class="col-sm-7">
                                                <p class="form-control-static">
                                                    <input type="file" style="border: 0px !important;" >
                                                </p>
                                    ...
                                    <section id="renovacion">
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                                <p class="form-control-static"><b>4.2 .- PARA RENOVACIÓN: </b></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Certificado de Historial Dosimétrico de los últimos 3 años emitido por el Instituto de Salud Pública de Chile: </label>
                                            <div class="col-sm-7">
                                                <p class="form-control-static">
                                                    <input type="file" style="border: 0px !important;" >
                                                </p>
                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="col-sm-5 control-label form-label">Copia de la Resolución a renovar: </label>
                                            <div class="col-sm-7">
                                                <p class="form-control-static">
                                                    <input type="file" style="border: 0px !important;" >
                                                </p>
